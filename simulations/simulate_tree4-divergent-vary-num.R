...
output_data = F # only output data, no running Zscore
if(!output_data)
{
...
#  write.csv(pbmc.combined@meta.data, file = "../simulation_results_new/simulation_results4/simulation4-0_merge_metadata.csv")
  ...
  #   }
  #   
  #   write.csv(cortex@assays$integrated@scale.data, file = paste0(prefix, "simulation_data2/simulation4-0_", ss, "_integrated_scaled.csv"))
  #   write.csv(cortex@meta.data, file = paste0(prefix, "simulation_data2/simulation4-0_", ss, "_integrated_metadata.csv"))
  #   quit()
  # }
  # 
...
save(influence_score, Zscore, file = paste0(prefix, 'vary/4-0_', subn,'_', ss, '.rdat'))
