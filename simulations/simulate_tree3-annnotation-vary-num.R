...
prefix = "~/Dropbox (Gladstone)/cell_hierarchy/cellwalk/simulation_results_new/simulation_results3/vary/"
...
save(confusion, aa, aa_tr, file = paste0(prefix, '3_both_', subn,'_', ss, '.rdat'))
